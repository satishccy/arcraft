 ...
 */
var _a;
import algosdk, { ALGORAND_ZERO_ADDRESS_STRING, AtomicTransactionComposer, } from 'algosdk';
import { lookup as mimeTypeLookup, lookupFromFile } from './mimeUtils';
import fs from 'fs';
import { CID } from 'multiformats/cid';
import * as digest from 'multiformats/hashes/digest';
import { getAlgodClient, getIndexerClient, calculateSHA256, UniversalBuffer, } from './utils';
...
export class Arc19 extends CoreAsset {
    ...
    static createReserveAddressFromIpfsCid(ipfsCid) {
        ...
        const reserveAddress = algosdk.encodeAddress(Uint8Array.from(UniversalBuffer.from(decoded.multihash.digest)));
